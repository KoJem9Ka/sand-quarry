...
import { modalConsultationClose, useIsModalConsultationOpen } from '@/components/ModalConsultation/modal-consultation.store';
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex flex-wrap">
            <a href={config.contacts.whatsapp} target="_blank" className="grow" onClick={modalConsultationClose}>
            ...
            <a href={config.contacts.telegram} target="_blank" className="grow" onClick={modalConsultationClose}>
